...
class ConnectionPoolSingleton:
    ...
    @staticmethod
    def __getInstance():
        """Checks for an instance of ConnectionPoolSingleton. If there is none,
        it will automatically call the __init__ method"""
        if ConnectionPoolSingleton.__INSTANCE is None:
    ...
    def __init__(self):
        ...
        if ConnectionPoolSingleton.__INSTANCE is not None:
            ...
            ConnectionPoolSingleton.__connection_pool = psycopg2.pool.ThreadedConnectionPool(1, 30,
                             host='modcat.ci3tyclo8vsc.us-east-1.rds.amazonaws.com',
                             user='modcatuser',
                             password='M0dC2tc2t2l0g',
                             database ='modcat')
